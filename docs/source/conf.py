# -*- coding: utf-8 -*-
#
# weblocks-websocket documentation build configuration file, created by
...
htmlhelp_basename = 'weblocks-websocketdoc'
...
latex_documents = [
  ('index', 'weblocks-websocket.tex', u'weblocks-websocket Documentation',
   u'', 'manual'),
]
...
man_pages = [
    ('index', 'weblocks-websocket', u'weblocks-websocket Documentation',
     [u''], 1)
]
