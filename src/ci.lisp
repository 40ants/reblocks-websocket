(uiop:define-package #:reblocks-websocket-ci/ci
  (:use #:cl)
...
(defworkflow linter
  ...
  :jobs ((40ants-ci/jobs/linter:linter
          :asdf-systems ("reblocks-websocket"
...
(defworkflow docs
  ...
  :on-pull-request t
  :cache t
  :jobs ((build-docs :asdf-system "reblocks-websocket-docs")))
...
(defworkflow ci
  ...
  :cache t
  :jobs ((run-tests
          :asdf-system "reblocks-websocket"
          :lisp ("sbcl-bin"
